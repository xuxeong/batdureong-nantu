...
그 밖의 세부 배치, 회복 퀵메뉴, 정비 허브 내부, 대화·투항·결과·엔딩 화면의 세부 표현,
접근성·오디오 UI는 `DEC-UI-001`, `DEC-UI-003`, `DEC-UI-006~013`, `DEC-UI-015~016`, `DEC-UI-019~021`, `DEC-UI-023`,
