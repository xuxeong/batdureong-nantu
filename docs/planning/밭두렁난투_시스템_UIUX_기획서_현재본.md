...
다음은 구조가 아니라 실제 콘텐츠·밸런스 작업이다. 2026-08-04 기준 아래 값은 대부분 승인
데이터에 작성됐으며, 남은 것은 화면 고정 문구(`DEC-CONTENT-018`)와 아트 리소스 자체의
제작이다. 공포도 증가량은 `DEC-RESIDENT-048`에서 확정했고 `fear_increments.csv` 승인이
남아 있다.
