...
기준 목업: `assets/source/phase-a/A1_daytime_gameplay_mockup_v5.png`

- 상태: **확정** (2026-08-05)
- 제작 방식: 목업 단순 크롭 금지. 같은 계열을 통합 시트 한 장에 생성한 뒤 분리한다.
- 다음 수정 시 개별 PNG만 보지 말고 반드시 해당 통합 시트와 A1-v5를 함께 참조한다.
...
|---|---|---:|---|
| `asset.ui.quickslot_count_badge` | `assets/final/ui/quickslot_count_badge.png` | 46×40 | 투척 퀵슬롯 수량 배지. `item_slot_badge.png`의 배지 형태를 기준으로 Figma에서 분리 제작했으며 각 퀵슬롯 우하단에 배치한다 |
